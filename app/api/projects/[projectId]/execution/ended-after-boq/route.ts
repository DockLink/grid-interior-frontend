...
import type { EndedAfterBoqResponse } from "@/types/execution";
...
export async function GET(req: NextRequest, context: RouteContext) {
  ...
  const result = await backendFetch<EndedAfterBoqResponse>(
    `/projects/${projectId}/execution/ended-after-boq`,
    {
      method: "GET",
