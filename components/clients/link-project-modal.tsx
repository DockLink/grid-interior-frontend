...
import { useLinkProjectToClient } from "@/hooks/use-link-project-to-client";
...
export function LinkProjectModal({
  ...
  const { linkProject, isLinking } = useLinkProjectToClient(clientId);
      ...
      >
        <div className="mb-5 flex items-center justify-between">
          <div>
            ...
            <p className="m-0 text-[13px] text-[var(--figma-gray500)]">Select a project to associate with this client</p>
          </div>
          <button
            type="button"
            onClick={onClose}
